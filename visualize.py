...
def visualize_random_agents(num_episodes=10, fps=60):
...
def visualize_trained_agent(model_path: str = None, num_episodes: int = 10):
    """
    ...
    visualize_random_agents(num_episodes)
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        if mode == "human":
            ...
            visualize_random_agents(episodes)
        elif mode == "trained":
